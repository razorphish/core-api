...
class ApplicationSettingsRepository {
    ...
    */
    insertEmailNotification(id, body, callback) {
        logger
            .debug(`${this._classInfo}.insertEmailNotification(${id})`);
        ...
        model.update(
            ...
            .catch(error => {
                logger.error(`${this._classInfo}.insertEmailNotification(${id})::update`, error);
                return callback(error);
            });
    }
    ...
    */
    insertNotification(id, body, callback) {
        ...
        model.update(
            ...
            .catch(error => {
                logger.error(`${this._classInfo}.insertNotification(${id})::update`, error);
                return callback(error);
            });
    }
    ...
    */
    insertNotificationAction(id, notificationId, body, callback) {
        logger.debug(`${this._classInfo}.insertNotificationAction(${id},${notificationId})`);
        ...
        model.update(
            ...
            .catch(error => {
                logger.error(`${this._classInfo}.insertNotificationAction(${id})::update`, error);
                return callback(error);
            });
    }
    ...
    */
    updateEmailNotification(id, emailNotificationId, body, callback) {
        logger
            .debug(`${this._classInfo}.updateEmailNotification(${id},${emailNotificationId})`);
