...
class SubscriptionPlanRepository {
  ...
  /**
   * Gets all {subscriptionPlan} paginated
  ...
  getDetails(id, callback) {
    ...
    model
      ...
      .populate({
        path: 'items',
        select:
          '_id amount amount name description saleAmount typeId limit dateCreated dateModified'
      })
      .populate({
        path: 'users',
        select:
          '_id frequencyId statusId dateStart dateEnd dateCreated dateModified',
        populate: [
          {
            path: 'userId',
