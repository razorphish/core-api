// [SubscriptionJob] Repository
const model = require('../../models/subscription/subscription-job.model');
const logger = require('../../../../lib/winston.logger');

/**
 * [SubscriptionJob] Repository
 * @author Antonio Marasco
 * @class [SubscriptionJob] Repository
 */
class SubscriptionJobRepository {
  /**
   * Constructor for {subscriptionJob}
   */
  constructor() {
    // Logging Info
    this._classInfo = '*** [SubscriptionJob].repository';
  }
  ...
  /**
   * Gets all {subscriptionJob} paginated
  ...
  /**
   * Delete a {subscriptionJob} by id
...
module.exports = new SubscriptionJobRepository();
