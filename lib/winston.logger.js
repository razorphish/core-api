...
// options.exceptionHandlers.file.filename =
// `${appRoot}/logs/${options.exceptionHandlers.file.filename}`;

options.file.filename = `logs/${options.file.filename}`;
options.exceptionHandlers.file.filename = `logs/${options.exceptionHandlers.file.filename}`;
