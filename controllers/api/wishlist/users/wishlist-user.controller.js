...
const repo = require('../../../../app/database/repositories/wishlist/wishlist-user.repository');
const utils = require('../../../../lib/utils');
const logger = require('../../../../lib/winston.logger');

/**
 * Wishlist Application Settings for items Api Controller
 * http://.../api/wishlist/users
 * @author Antonio Marasco
 */
class WishlistUsersController {
  /**
...
module.exports = WishlistUsersController;
